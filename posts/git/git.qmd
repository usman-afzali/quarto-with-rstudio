...
![Figure showing a screenshot of homebrew website](homebrew.png)
...
![Figure showing GitHub screen after repository creation](githubscreen.png)
...
![Figure showing Git dialogue box on RStudio](git-dialogue-RStudio.png)
...
![terminal screenshot](terminalsc.png)
...
A branch can be created on GitHub by typing a name in the window shown below after clicking on "main": ![Fig new branch on GitHub](GitHub-branch.png)

For example, the new branch is called "pycode" within which a python file can be created, named "experimental.py". When you fetch git, it tells you that we have a new branch: ![Fig showing new branch name](branch-name.png)
